...
public class DrugBasedCRBM {
    ...
    private static void load_distinction_data(String data_folder){
        try {
            ...
            X_train_isMissing = DoubleMatrix.loadCSVFile(data_folder + "df_isMissing_drug_rbm.csv");
    ...
    private static void evaluate_distinction(DrugTargetCRBM crbm, String results_folder){
        ...
        for(int k = 0; k < X_train_direct.getRows(); k++){
            ...
            double[][] prob = { probDrug_direct.getRow(k).toArray(), probDrug_indirect.getRow(k).toArray() };
    ...
    private static void evaluate_no_distinction(DrugTargetCRBM crbm, String results_folder){
        ...
        for(int k = 0; k < X_train_direct.getRows(); k++){
            ...
            double[][] prob_direct = { probDrug_direct.getRow(k).toArray() };
            ...
            double[][] prob_indirect = { probDrug_indirect.getRow(k).toArray() };
